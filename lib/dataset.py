...
class Dataset:
    ...
    def trainLoader(self):
        train_file_names = sorted([line.rstrip() for line in open('data/scannet/meta_data/scannetv2_train.txt')])
        train_file_names = list(map(lambda name: 'data/scannet/scannet_data/{}_pointgroup.pth'.format(name),train_file_names))
    ...
    def valLoader(self):
        val_file_names = sorted([line.rstrip() for line in open('data/scannet/meta_data/scannetv2_val.txt')])
        val_file_names = list(map(lambda name: 'data/scannet/scannet_data/{}_pointgroup.pth'.format(name),train_file_names))
    ...
    def testLoader(self):
        self.test_file_names = sorted([line.rstrip() for line in open('data/scannet/meta_data/scannetv2_test.txt')])
        self.test_file_names = list(map(lambda name: 'data/scannet/scannet_data/{}_pointgroup.pth'.format(name),train_file_names))
