...
from models.caption_module import PlainCapModule, AttentionCapModule
    ...
    emb_size=300, hidden_size=512):
        ...
        if not no_caption:
            if use_topdown:
                ...
                self.caption = PlainCapModule(128,emb_size,hidden_size)  #(vocabulary, embeddings, emb_size, 128, hidden_size, num_proposal)
